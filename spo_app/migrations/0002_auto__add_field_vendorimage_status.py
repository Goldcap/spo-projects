...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VendorImage.status'
        db.add_column(u'spo_app_vendorimage', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VendorImage.status'
        db.delete_column(u'spo_app_vendorimage', 'status')
